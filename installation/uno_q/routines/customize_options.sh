...
Do you want to enable an Autohotspot? [y/N]"
    ...
    *) ;;
    ...
    if [ "$ENABLE_AUTOHOTSPOT" = true ]; then
        ...
        while [[ $response_autohotspot != "n" ]]; do
            print_c "
...
Do you want to change this values? [y/N]"
            ...
            [yY][eE][sS] | [yY])
                ...
                while [[ $response_ssid_length -lt 1 || $response_ssid_length -gt 32 ]]; do
                ...
                while [[ $response_pw_length -lt 8 || $response_pw_length -gt 63 ]]; do
                ...
                while [[ $response_country_code_length -ne 2 ]]; do
